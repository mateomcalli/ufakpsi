          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 font-crimson p-4 rounded-xl border border-gray-400 w-full xl:w-xl h-70">
              ...
              <a className="mt-auto" href="https://gainesvillethrives.org" target="_blank">
                <div className="bg-dblue/10 inset-shadow-sm/20 transition-shadow duration-300 hover:cursor-pointer hover:shadow-lg hover:inset-shadow-sm/0 flex items-center border border-dblue rounded-lg w-36 h-12">
