      ...
      <div className="flex  justify-between items-end w-full">
        <div className="flex flex-col self-start w-fit h-fit">
          <Image
            ...
            alt="AKPsi emblem"
          />
          <p className="text-nowrap font-crimson">© {today.getFullYear()} Alpha Kappa Psi</p>
        </div>
        <div className="relative flex flex-col pt-4 text-right">
          <div className="flex gap-4 relative pb-2">
            <Link 
              className='border text-gray-600 hover:text-dblue hover:opacity-100 transition-colors border-neutral-300 h-fit p-2 rounded-lg'
          ...
          <a 
            target="_blank" 
            rel="noopener noreferrer" 
            href="https://github.com/mateomcalli/ufakpsi" 
            className="w-fit ml-auto underline font-crimson hover:animate-rainbow bg-clip-text hover:text-transparent"
            style={{
              backgroundSize: '200%',
            }}
          >
          ...
          <a rel="noopener noreferrer" href="/admin" className="w-fit ml-auto underline font-crimson">Admins</a>
        </div>
      </div>
    </section>
  )
